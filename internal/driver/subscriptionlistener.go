...
func (d *Driver) startSubscriptionListener() error {
	...
	if err := d.configureMonitoredItems(ctx, sub, resources, deviceName); err != nil {
		return err
	}
...
func (d *Driver) configureMonitoredItems(ctx context.Context, sub *opcua.Subscription, resources, deviceName string) error {
